...
export default function music() {
  return (    
   <main className="w-full flex justify-center items-center mt-10 mb-1"> 
    ...
    <div className="sm:w-full md:w-[80%] sm:p-5 md:p-5 sm:h-auto md:h-[400px] flex sm:fles-col md:flex-row sm:justify-start md:justify-center sm:items-start md:items-center bg-black">
